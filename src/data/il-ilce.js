 ...
 * Güvenli statik veri — dış API bağımlılığı yok.
 * Kaynak: Resmi il/ilçe listesi (2024)
 */
...
/** İl listesi (alfabetik) */
export const getIller = () => Object.keys(IL_ILCE_DATA).sort((a, b) => a.localeCompare(b, 'tr'))

/** Seçilen ile ait ilçe listesi (alfabetik) */
export const getIlceler = (il) => {
  if (!il || !IL_ILCE_DATA[il]) return []
  return [...IL_ILCE_DATA[il]].sort((a, b) => a.localeCompare(b, 'tr'))
}

export default IL_ILCE_DATA
